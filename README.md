...
- Institutional evidence from the Transport for London (TfL), Office for National Statistics (ONS), etc.
- Visualization of data using MS Excel
### Assessment Outcome
This report was assessed at First-Class standard for its presentation, research depth, and systematic economic analysis. Feedback highlighted the comprehensive cost–benefit framework and strong use of data which strengthened the overall appraisal.
